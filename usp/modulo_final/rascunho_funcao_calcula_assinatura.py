...
def calcula_segunda_assinatura (texto):
    lista_de_palavras_do_texto = separa_palavras(texto)
    quantidade_de_palavras = len (lista_de_palavras_do_texto)
    numero_de_palavras_diferentes = n_palavras_diferentes (lista_de_palavras_do_texto)
    assinatura1 = numero_de_palavras_diferentes / quantidade_de_palavras
    return assinatura1



def calcula_terceira_assinatura (texto):
    lista_de_palavras_do_texto = separa_palavras(texto)
    quantidade_de_palavras = len (lista_de_palavras_do_texto)
    numero_de_palavras_unicas = n_palavras_unicas (lista_de_palavras_do_texto)
    assinatura2 = numero_de_palavras_unicas / quantidade_de_palavras
    return assinatura2
...
def calcula_assinatura(texto):
    ...
    assinatura.append (calcula_terceira_assinatura(texto))
